...
import { AiringShows, AiringShowsOptions, AppendToEpisode, AppendToMedia, AppendToMovie, AppendToPerson, AppendToSeason, AppendToShow, Collection, Company, Discover, DiscoverOptions, Episode, EpisodeOptions, KeywordOptions, KeywordResult, LibraryType, Media, MediaOptions, Movie, MovieOptions, NowPlayingMovies, NowPlayingMoviesOptions, Person, PersonOptions, PopularMedia, PopularMediaOptions, Recommendations, RecommendationsOptions, SearchOptions, SearchResult, Season, SeasonOptions, Similar, SimilarOptions, TopRatedMedia, TopRatedMediaOptions, TrendingMedia, TrendingMediaOptions, TVShow, TVShowOptions, UpcomingMovies, UpcomingMoviesOptions } from "./tmDBTypes";
...
export declare class TmDBApi {
    ...
    getMedia<Library extends LibraryType, Append extends AppendToMedia<Library>>(id: number, library: Library, options?: MediaOptions<Library, Append>): Promise<TMDBResponse<Media<Library, Append>>>;
    /**
